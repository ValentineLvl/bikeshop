...
const stripe = Stripe('sk_test_51JnJTVIfkRTuzzet5Y122sSGjIbdFrsduxlwSSfFGXtbPRZbKU2EiZKDPmXScWdQ77tw6b8THQ5k0PNocaVYSsie00GdhLmUiv');
...
router.get('/success', (req, res) => {
  res.render('success', { title: 'Commande validée' });
});

router.get('/cancel', (req, res) => {
  res.render('cancel', { title: 'Commande annulée' });
});
